...
from . import menus
from ..operators import rigid_bodies, soft_bodies, collision, mesh_generation, segments, mesh_rename, muscles
    ...
    if box:
       ...
       # context.scene.objects.active
        ...
        if len(selected_objects):
            ...
            #muscles.RenameMuscle.place_button(box, text='Rename mesh', infoBox=infoBox)
            mesh_rename.RenameMesh.place_button(box, text='Rename mesh', infoBox=infoBox)
            #global_properties.mesh_name.prop(context.scene, box, expand=True, text='Change Mesh Name')
